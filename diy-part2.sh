...
sed -i 's/192.168.1.1/192.168.9.111/g' package/base-files/files/bin/config_generate
sed -i 's/OpenWrt/Wanghao/g' package/base-files/files/bin/config_generate
